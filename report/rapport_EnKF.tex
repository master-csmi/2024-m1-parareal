...
\hypersetup{
    pdftitle={Application of the Ensemble Kalman Filter (EnKF) to the Lorenz System},
    pdfauthor={Narimane ZAOUACHE},
    pdfsubject={Application of the Ensemble Kalman Filter (EnKF) to the Lorenz System},
...
{ \huge \bfseries Application of the Ensemble Kalman Filter (EnKF) to the Lorenz System \\[0.4cm] }
