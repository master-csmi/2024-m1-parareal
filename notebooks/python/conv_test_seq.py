...
G_Nh=1
F_Nh=80
G3 = lambda tspan,u0, :rk4(lorenz_, tspan, u0, G_Nh)[1][-1]
F3 = lambda tspan,u0, :rk4(lorenz_, tspan, u0, F_Nh)[1][-1]

def lorenz_ref(t,ns):
    sol = solve_ivp(lorenz_, tspan, U0, method='RK45',t_eval= np.linspace(tspan[0],tspan[1],ns))
